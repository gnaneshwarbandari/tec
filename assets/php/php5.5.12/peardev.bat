...
FOR %%x IN ("C:\wamp\bin\php\php5.5.12\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\wamp\bin\php\php5.5.12\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\wamp\bin\php\php5.5.12"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\wamp\bin\php\php5.5.12\php.exe"
GOTO :INSTALLED
